...
$rdpFolder = "C:\path\to_remote\Desktop_connections_folder\Labnet" # open rdp and save the machine to this folder with the name you want to see in the popup
$sessions = @("machine_name", "machine_name", "machine_name", "*", "*") # this is for the name you want to view on your popup the actual name is setup in the rdp file where all the machine rdp sessions are saved
